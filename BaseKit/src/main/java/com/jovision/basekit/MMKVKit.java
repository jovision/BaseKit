 ...
 * @CreateDate: 2024/8/12 16:24
 * @Version: 1.0
 */
public class MMKVKit {


    private volatile static MMKVKit instance = null;
    ...
    public static MMKVKit getInstance() {
        if (instance == null) {
            synchronized (MMKVKit.class) {
                if (instance == null) {
                    instance = new MMKVKit();
                }
            }
        }
        return instance;
