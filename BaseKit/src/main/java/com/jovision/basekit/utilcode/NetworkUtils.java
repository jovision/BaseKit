package com.jovision.basekit.utilcode;
...
public final class NetworkUtils {
    ...
    public static boolean isUsingVPN(){
        ConnectivityManager cm = (ConnectivityManager) com.jovision.basekit.utilcode.Utils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
